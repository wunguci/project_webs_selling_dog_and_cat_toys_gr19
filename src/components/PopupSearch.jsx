...
const PopupSearch = ({
  ...
  return (
    <div className="popup-search absolute top-full left-0 w-full mt-1 bg-white shadow-lg rounded-md border z-50 border-gray-200 max-h-80 overflow-y-auto popup-search-container">
      {hasResults ? (
        <div className="p-2">
